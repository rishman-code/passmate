...
const INTRO_SLIDES: IntroSlide[] = [
  {
    ...
    body: "1.8 million people sit the DVSA theory test every year — fewer than half pass first time. Generic apps don't know where YOU specifically went wrong. GreenLight does.",
  },
  {
    icon: 'stats-chart-outline',
    title: 'Target Your Weak Spots',
    body: 'Every answer you give is tracked. GreenLight automatically shows you the questions you need most — no wasted revision time.',
  },
  {
    icon: 'bulb-outline',
          ...
          <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
            ...
            {page.kind === 'plan' ? (
              <View style={styles.stepContent} testID="onboarding-plan-step">
                ...
                <ThemedText themeColor="textSecondary">
                  This is what GreenLight holds you to — it adjusts automatically as you practise.
                </ThemedText>
